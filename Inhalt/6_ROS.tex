...
\begin{itemize}
    ...
    \item \bverb|void close_connection()| schließt die Verbindung mit dem jeweiligen Client.
...
Außerdem stellt die Klasse eine Callbackfunktion \bverb|_subscribtion_callback()| bereit, die beim empfangen einer Topic aus ROS ausgeführt wird. 
...
\footnote{Wenn ROS in einer virtuellen Maschine genutzt wird, muss eventuell der Serverport 2888 weitergeleitet werden. Außerdem könnte der Port von der Host Firewall blockiert werden.}
