...
Wie auch bei der Bachelor Vorgängergruppe, soll der Roboter schnell reproduziert werden. Jedoch gefiel uns nicht, dass die notwendigen Bauteile einzelnd auf der Grundplatte 
...
an Kanten oder auch an anderen Robotern hängen bleibt. Es wurde eine kreisförmige Hülle aus zwei halbkreisförmigen Hüllen mithilfe eines 3D Druckers gedruckt. 
Zudem wird der Roboter auf der Oberseite von einem auch selbstgedruckten diffusen Glas abgedeckt. Das hat den Sinn, dass die einzelnen LEDs nicht blenden und die 
...
Das diffuse Glas hat 2 kleine Löcher für die externen Mikrofone vom Marvelmind-sensor. 
...
Beim Verschrauben der beiden Platinen sollte zuerst sichergestellt werden, dass die Steckverbindung 
verbunden sind. Anschließend wird die untere Platine mit der oberen mithilfe von 4 Schrauben verschraubt.
...
Schrauben an der Platine verschraubt werden. Danach kann man die beiden Außenteile ebenfalls mit 2 Schrauben verschrauben. 
