...
Softwareseitig wurde eine Firmware entwickelt, die einfach ohne gro{\ss}e Änderungen auf jeden Roboter geflasht werden kann. Auf der Mikroebene haben die einzelnen Roboter keine Kenntnis voneinander. 
...
Das zweite Ziel war die Erschaffung einer einheitlichen, skalierbaren Schnittstelle zwischen Roboter und Computer.
...
Ein Zwischenziel der Webentwicklung war au{\ss}erdem ein Mechanismus, über den Roboter im unterliegenden Computersystem erkannt werden und somit ohne spezielle Registrierung über die Web-App ansteuerbar sind.
...
Trotz eines dritten stationären Beacons gibt es immer noch gelegentlich Ausrei{\ss}er bei den Marvelmind Messdaten. Diese Ausrei{\ss}er könnten erkannt werden und durch dynamisches Anheben der Kovarianzen des Messrauschens verworfen werden.\\
