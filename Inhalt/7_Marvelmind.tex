...
Diese ist schematisch in Abbildung xx zu sehen.
<Bild einfügen>

Trotz des Hinzufügens eines dritten Beacons war allerdings weiterhin keine wirkliche Verbesserung in der Lokalsierung des Roboters und in der Stabilität der Marvelmind-Messdaten zu erkennen.
...
Dadurch bildeten die Beacons ungefähr Eckpunkte eines Dreiecks ab, was in Abbildung \ref{fig:marv_three_beacons} sichtbar wird.
...
In den Gebäuden der Hochschule in der Wassertorstraße gibt es einige Räume, die keine geschlossene Deckenabhängung haben.
...
Dies geschieht, indem man in der Auflistung der gesamt möglichen Beacons jeweils der Beacon mit der korrekten Adresse angeklickt werden.\\[\baselineskip]
...
\begin{itemize}
    \item "`Radio frequency band"' \rightarrow \xspace 868 MHz
    \item "`Parameters of radio \rightarrow  Radio profile"' \rightarrow \xspace 153 Kbps
    \item "`Device address"' \rightarrow \xspace Festlegen der einzelnen Geräteadressen 
\end{itemize}
...
Obwohl während dieser Projektarbeit einige sehr wichtige Erkenntnisse gewonnen wurden, die die Genauigkeit und Stabilität der Lokalisierungsdaten des Marvelmind-Systems verbesserten, bleiben für einige Punkten weiterhin ein Raum für Verbesserungen.
...
Allerdings können zu diesem Zeitpunkt keine weiteren expliziten Lösungsansätze vorgeschlagen werden, da diese von unserer Projektgruppe letztlich bereits durchgeführt wurden.
