...
\end{center}
\verb|namespace| ist die Identifikationskonstante im Flash des ESP32 und wurde in diesem Projekt auf \verb|robot_| + Nummerierung gesetzt.
Damit der ESP32 mit den Nachrichten auf der Topics umgehen kann, wurde für alle verwendeten ROS-Nachrichtentypen ein entsprechender Datentyp in der ESP32 Software implementiert.
