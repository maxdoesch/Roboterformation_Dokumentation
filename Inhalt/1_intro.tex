...
Die Hardware ist basierend auf Ergebnissen der vorherigen Projektgruppen entwickelt worden.
...
Dadurch kann ein 360 Grad Fahren ermöglicht werden. Der hierzu benötigte Strom wird durch einen Akku mit 12V bereitgestellt.\\[\baselineskip]
...
Der Code wird in der Programmiersprache C++ verfasst und sendet dann über sogenannte Publisher Daten auf Topics.
Der ROS-Master speichert diese Nachrichten und stellt sie anderen Nodes, die dieses Topic abonnieren, den sogenannten Subscribern, zur Verfügung.
...
Dazu wird an der Au{\ss}enseite des Motors gemessen, wie oft sich das Rad innerhalb einer Sekunde vollständig gedreht hat.
...
Unsere Web-App stellt die Oberfläche für den Endnutzer zur Verfügung.
...
Dem geht zuvor die Eingabe der gewünschten Trajektorie im ROS-System einher.
Zusätzlich können Einstellungen zur Geschwindigkeit und Licht in der WebApp vorgenommen werden.
