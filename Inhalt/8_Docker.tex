...
Im Unterkapitel \hyperref[dockercompose]{Docker-Compose} werden in einer \textit{dokcer-compose.yml} Datei mehrere \hyperref[buildBefehle]{build-Befehle} aufgerufen, welche zu dem eigentlichen \textit{Dockerfile} nagivieren und diesen als 
\newline Hauptimage bauen. Im Folgenden werden die Befehle aus dem \textit{Dockerfile} und deren \newline Funktionen anhand eines Beispiels aus unserem Projekt erklärt und geschildert. 
