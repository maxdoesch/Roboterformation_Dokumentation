...
\begin{description}
    ...
    Anschließend muss REGIN mit VDD verbunden werden (Lötbrücke blau) und mithilfe von z.B. einem Kupferdraht mit 3.3V versorgt werden. (Abbildung \ref{fig:cp2102nfehlerkorrekturlayout} blau)
\end{description}
