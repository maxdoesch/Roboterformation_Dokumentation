...
Ähnlich wie ein normales Betriebssystem arbeitet es mit Tasks, so dass mehrere Programmzweige parallel ablaufen können.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/Softwarearchitektur_ESP32/ESP32_Architektur.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/Softwarearchitektur_ESP32/RosBridgeClientClass.png}
