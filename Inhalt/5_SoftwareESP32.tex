...
\section{LedStrip}
Die Klasse LedStrip ist für die Ansteuerung der LEDs zuständig. Das Ledband empfängt einen Bitstream, von welchem sich die einzelnen LEDs die ersten 24 Bits abschneiden und den verbleibenden Bitstream an die restlichen LEDs weiterführt.
...
dass das Interrupt möglichst schnell durchläuft und niemals blockiert wird. Au{\ss}erdem wird aus MotorController der Enable Pin für den Motortreiber aktiviert.
...
\begin{itemize}
    ...
    \item \bverb|void _data_logger_task(void *pvParameters)| sendet den Puffer an das ROS-System, falls dieser eine maximale Grö{\ss}e erreicht hat.
\end{itemize}
